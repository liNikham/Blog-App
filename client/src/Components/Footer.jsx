   ...
   <Footer container className='border border-t-8 border-teal-500'>
    <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:gird-cols-1">
          ...
          <span className='px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'>Nikhil's</span> 
           Blog
            ...
            <div className="grid gird-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:grid-6">
                <div>
                ...
                <Footer.LinkGroup col>
                    <Footer.Link href="https://www.github/liNikham.com" target='_blank'
                    rel='noopener noreferrer'>
                                GihHub
                    </Footer.Link>
                ...
                <Footer.LinkGroup col>
                    <Footer.Link href="https://github.com/liNikham" target='_blank'
                    rel='noopener noreferrer'>
                                Privacy
                    </Footer.Link>
                <Footer.Link href="#" target='_blank'
        ...
        <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            ...
            <Footer.Icon href="https://github.com/liNikham" icon = {BsGithub}/>
